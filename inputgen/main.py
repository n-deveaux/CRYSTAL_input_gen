...
def main():
    ...
    parser.add_argument('-t', '--type', help='The type of input file to generate', default='sp')
    parser.add_argument('-w', '--wavelength', help='The wavelength of the light source (nm)', default='0')
    parser.add_argument('-s', '--shrink', help='The SHRINK parameters for the sampling of the first BZ', default='4')
    ...
    gen.generate_input(args.type, args.wavelength)
